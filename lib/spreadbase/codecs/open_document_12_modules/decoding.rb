  ...
  module Codecs # :nodoc:
    ...
    module OpenDocument12Modules # :nodoc:
      ...
      module Decoding
        ...
        #
        def decode_document_node( root_node )
        ...
        def decode_table_node( table_node )
          ...
          # Watch out the :flatten; a single column can represent multiple columns (table:number-columns-repeated)
          #
          table.column_width_styles = column_nodes.map { | node | decode_column_width_style( node ) }.flatten
          table.data                = row_nodes.map { | node | decode_row_node( node ) }
        ...
        def decode_row_node( row_node )
          ...
          #
          values = cell_nodes.map { | node | decode_cell_node( node ) }.flatten

...
<manifest:manifest xmlns:manifest="urn:oasis:names:tc:opendocument:xmlns:manifest:1.0" manifest:version="1.2">
  ...
  <manifest:file-entry manifest:media-type="text/xml" manifest:full-path="content.xml"/>
      ...
      #
      # The generated archive contains the strictly necessary data required to have
      ...
      def encode_to_archive( el_document, options={} )
        ...
        document_buffer = encode_to_content_xml( el_document, :prettify => prettify, :force_18_strings_encoding => force_18_strings_encoding )
        zip_buffer      = ''
      ...
      # +options+:
      #
      # +prettify+::              Prettifies the content.xml to be human readable.
      #
      ...
      def encode_to_content_xml( el_document, options={} )
        ...
        document_xml_root = encode_to_document_node( el_document, :force_18_strings_encoding => force_18_strings_encoding )
      ...
      def decode_content_xml( content_xml_data )
        ...
        decode_document_node( root_node )
      end

...
module SpreadBase # :nodoc:
  ...
  module Helpers
    ...
    #                           Entries can be of different sizes; in this case the filler values will be nils.
    #
    # +options+:
    # +row_prefix+::            Prefix this string to each row.
    # +with_header+::           First row will be separated from the remaining ones.
    #
    # +formatting_block+::      If passed, values will be formatted according to the retuns value of the block; otherwise, #inspect will be called.
    #
